...
public class Plurals {
    private static final Set<String> unpluralizables = Set.of(
            "equipment", "information", "rice", "money", "species", "series",
            "fish", "sheep", "deer");

    private static final List<Replacer> singularizations = List.of(
    ...
    private static final List<Replacer> pluralizations = List.of(
